...
!   uses: core_hgroup gyre_model gyre_model_par core_kinds gyre_util gyre_constants gyre_model_util ISO_FORTRAN_ENV gyre_evol_model
!   provides: gyre_gsm_file
!end dependencies
!
!end fpx3_header
...
120    format(3X,A,1X,F4.2,1X,A)
    ...
    write(UNIT=ERROR_UNIT, FMT=*) 'ABORT at line 275 <gyre_gsm_file:read_gsm_data>:'
    write(UNIT=ERROR_UNIT, FMT=*) 'Unrecognized GSM file version'
