...
!   uses: gyre_mode_par gyre_diff_factory gyre_osc_par gyre_rad_match gyre_ext gyre_context gyre_num_par gyre_rad_eqns gyre_state gyre_point ISO_FORTRAN_ENV core_kinds
