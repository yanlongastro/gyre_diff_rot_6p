...
!   uses: gyre_mode_par gyre_constants gyre_out_par gyre_num_par core_parallel ISO_FORTRAN_ENV core_memory gyre_osc_par gyre_grid_par core_kinds gyre_scan_par
!   provides: gyre_util
!end dependencies
!
!end fpx3_header
