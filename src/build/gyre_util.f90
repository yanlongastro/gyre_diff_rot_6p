...
!   uses: core_memory gyre_constants gyre_mode_par gyre_grid_par gyre_scan_par gyre_osc_par core_parallel gyre_num_par ISO_FORTRAN_ENV gyre_out_par core_kinds
!   provides: gyre_util
!end dependencies
!
!end fpx3_header
