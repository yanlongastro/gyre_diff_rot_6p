...
!   uses: gyre_model core_kinds gyre_model_util gyre_evol_model gyre_util core_order gyre_constants gyre_model_par ISO_FORTRAN_ENV
!   provides: gyre_losc_file
!end dependencies
!
!end fpx3_header
...
120    format(3X,A,1X,I0,1X,A)
    ...
    write(UNIT=ERROR_UNIT, FMT=*) 'INFO at line 121 <gyre_losc_file:read_losc_model>:'
    write(UNIT=ERROR_UNIT, FMT=*) 'Gravitational constant in LOSC file does not match value specified in &constants'
