...
!   uses: gyre_grid_par core_kinds gyre_point gyre_grid gyre_rot gyre_freq ISO_FORTRAN_ENV gyre_state gyre_rot_factory gyre_interp core_order gyre_model gyre_mode_par gyre_osc_par
