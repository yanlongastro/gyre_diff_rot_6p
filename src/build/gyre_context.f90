...
!   uses: core_order core_kinds gyre_freq gyre_state gyre_interp gyre_mode_par gyre_rot_factory ISO_FORTRAN_ENV gyre_grid gyre_point gyre_osc_par gyre_model gyre_rot gyre_grid_par
!   provides: gyre_context
!end dependencies
!
!end fpx3_header
! Module   : gyre_context 
...
contains
  ...
  subroutine read_deps_ (ml, md_p, os_p, pt_i, pt_o, in_eps_rho, in_eps_T)
    ...
    write(UNIT=ERROR_UNIT, FMT=*) 'ABORT at line 276 <gyre_context:read_deps_>:'
    write(UNIT=ERROR_UNIT, FMT=*) 'Invalid deps_file_format'
