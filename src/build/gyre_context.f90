...
!   uses: core_kinds gyre_osc_par gyre_state gyre_grid_par ISO_FORTRAN_ENV gyre_grid gyre_model gyre_point gyre_freq gyre_interp gyre_rot_factory gyre_mode_par core_order gyre_rot
