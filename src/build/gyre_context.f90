...
!   uses: core_order gyre_grid gyre_interp ISO_FORTRAN_ENV gyre_mode_par gyre_grid_par gyre_rot_factory core_kinds gyre_model gyre_point gyre_freq gyre_osc_par gyre_rot gyre_state
