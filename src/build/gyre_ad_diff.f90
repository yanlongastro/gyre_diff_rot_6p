...
!   uses: gyre_ext gyre_state gyre_diff gyre_ad_match core_kinds gyre_diff_factory gyre_mode_par gyre_point ISO_FORTRAN_ENV gyre_osc_par gyre_context gyre_num_par gyre_ad_eqns
