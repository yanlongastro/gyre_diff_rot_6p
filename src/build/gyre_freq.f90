...
!   uses: gyre_model gyre_osc_par gyre_mode_par gyre_evol_model ISO_FORTRAN_ENV gyre_util gyre_hom_model gyre_constants gyre_point gyre_poly_model gyre_atmos core_kinds
!   provides: gyre_freq
!end dependencies
!
!end fpx3_header
