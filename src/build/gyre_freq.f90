...
!   uses: gyre_poly_model gyre_osc_par ISO_FORTRAN_ENV gyre_mode_par gyre_hom_model gyre_util gyre_model gyre_constants gyre_atmos core_kinds gyre_point gyre_evol_model
!   provides: gyre_freq
!end dependencies
!
!end fpx3_header
