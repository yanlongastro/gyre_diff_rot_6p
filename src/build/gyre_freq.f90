...
!   uses: ISO_FORTRAN_ENV gyre_hom_model gyre_atmos gyre_osc_par gyre_util gyre_mode_par gyre_model gyre_point gyre_poly_model gyre_evol_model gyre_constants core_kinds
!   provides: gyre_freq
!end dependencies
!
!end fpx3_header
