...
!   uses: ISO_FORTRAN_ENV gyre_hom_model gyre_osc_par gyre_evol_model core_kinds gyre_util gyre_poly_model gyre_mode_par gyre_constants gyre_point gyre_atmos gyre_model
!   provides: gyre_freq
!end dependencies
!
!end fpx3_header
