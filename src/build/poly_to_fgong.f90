...
!   uses: gyre_grid gyre_poly_file gyre_model gyre_constants ISO_FORTRAN_ENV gyre_model_par core_kinds gyre_poly_model core_system
!   provides: 
!end dependencies
!
!end fpx3_header
...
program poly_to_fgong
  ...
  ! Read parameters
    ...
    if(.NOT. (n_arg() == 3)) then
      write(UNIT=ERROR_UNIT, FMT=*) 'ASSERT ''n_arg() == 3'' failed at line 71 <poly_to_fgong>:'
      write(UNIT=ERROR_UNIT, FMT=*) 'Syntax: poly_to_fgong in_filename out_filename drop_outer'
      stop
    endif
