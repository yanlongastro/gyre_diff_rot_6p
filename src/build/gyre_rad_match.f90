...
!   uses: gyre_ext ISO_FORTRAN_ENV gyre_diff gyre_mode_par gyre_context gyre_model gyre_model_util gyre_osc_par gyre_point gyre_rad_trans gyre_state core_kinds
