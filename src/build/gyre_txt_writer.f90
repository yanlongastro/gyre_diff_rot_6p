...
!   uses: gyre_writer core_kinds ISO_FORTRAN_ENV gyre_util core_memory
...
!****
  ...
  subroutine write_i_0 (this, name, data)
    ...
    write(this%s_data(this%n_s), I_FORMAT) data
...
!****
  ...
  subroutine write_i_1 (this, name, data)
    ...
    do k = 1, this%n
       write(this%v_data(k,this%n_v), I_FORMAT) data(k)
    end do
  ...
  subroutine write_r_0 (this, name, data)
    ...
    write(this%s_data(this%n_s), R_FORMAT) data
...
!****
  ...
  subroutine write_r_1 (this, name, data)
    ...
    do k = 1, this%n
       write(this%v_data(k,this%n_v), R_FORMAT) data(k)
    end do
  ...
  subroutine write_a_0 (this, name, data)
    ...
    write(this%s_data(this%n_s), A_FORMAT) data
...
!****
  ...
  subroutine write_a_1 (this, name, data)
    ...
    do k = 1, this%n
       write(this%v_data(k,this%n_v), A_FORMAT) data(k)
    end do
