...
!   uses: core_kinds ISO_FORTRAN_ENV gyre_grid_spec gyre_osc_par gyre_state gyre_mode_par gyre_context gyre_freq gyre_grid_par gyre_constants gyre_util gyre_model gyre_grid_util gyre_point gyre_grid
