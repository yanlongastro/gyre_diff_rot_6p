...
!   uses: gyre_constants gyre_state gyre_grid_util gyre_grid_spec gyre_freq gyre_grid_par gyre_context gyre_grid gyre_osc_par gyre_mode_par ISO_FORTRAN_ENV core_kinds gyre_point gyre_model gyre_util
