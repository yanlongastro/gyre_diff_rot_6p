...
!   uses: gyre_context gyre_grid gyre_wave gyre_osc_par core_parallel gyre_util core_kinds ISO_FORTRAN_ENV gyre_ext gyre_grid_util gyre_state gyre_mode_par
!   provides: gyre_mode
!end dependencies
!
!end fpx3_header
