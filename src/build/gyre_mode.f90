...
!   uses: ISO_FORTRAN_ENV gyre_grid gyre_grid_util core_kinds core_parallel gyre_util gyre_osc_par gyre_context gyre_ext gyre_mode_par gyre_wave gyre_state
!   provides: gyre_mode
!end dependencies
!
!end fpx3_header
