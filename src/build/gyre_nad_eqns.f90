...
!   uses: gyre_model_util gyre_model gyre_osc_par core_kinds gyre_point gyre_eqns gyre_context gyre_nad_trans gyre_linalg gyre_state ISO_FORTRAN_ENV gyre_mode_par
