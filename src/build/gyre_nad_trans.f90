...
!   uses: gyre_point gyre_model ISO_FORTRAN_ENV gyre_mode_par gyre_state core_kinds gyre_osc_par gyre_model_util gyre_context
...
contains
  ...
  function nad_trans_t_ (cx, md_p, os_p) result (tr)
    ...
    write(UNIT=ERROR_UNIT, FMT=*) 'ABORT at line 123 <gyre_nad_trans:nad_trans_t_>:'
  ...
  subroutine trans_eqns (this, xA, i, st, from)
    ...
    write(UNIT=ERROR_UNIT, FMT=*) 'ABORT at line 223 <gyre_nad_trans:trans_eqns>:'
  ...
  function G_ (this, i, st) result (G)
    ...
    write(UNIT=ERROR_UNIT, FMT=*) 'ABORT at line 353 <gyre_nad_trans:G_>:'
  ...
  function H_ (this, i, st) result (H)
    ...
    write(UNIT=ERROR_UNIT, FMT=*) 'ABORT at line 635 <gyre_nad_trans:H_>:'
    write(UNIT=ERROR_UNIT, FMT=*) 'Invalid set'
  ...
  function dH_ (this, i, st) result (dH)
    ...
    write(UNIT=ERROR_UNIT, FMT=*) 'ABORT at line 916 <gyre_nad_trans:dH_>:'
    write(UNIT=ERROR_UNIT, FMT=*) 'Invalid set'
